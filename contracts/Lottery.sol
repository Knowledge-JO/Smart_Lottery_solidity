...
// Pick a random winner (verifiably random and untemperable)

// winner to be selected evry X minutes -> completly automated
...
contract Lottery is VRFConsumerBaseV2, AutomationCompatibleInterface {
    ...
    function gerNumberOfPlayers() public view returns (uint256) {
